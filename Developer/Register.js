...
export const Register = () => {
    return (
        <View style={{backgroundColor: '#F3F5F6', width: '100%',
        height: '100%',marginTop: -1}}>
            ...
            <TouchableOpacity style={{borderwidth:1, borderColor:'white', borderRadius: 15, alignItems: 'center',padding:15, backgroundColor: 'black', marginTop: 20, width: 300, alignSelf: 'center',}}>
